...
状态登记和外部复核讨论链接见 [WebBrain discussion #3](https://huggingface.co/webbrain-one/DeepSeek-V4-Flash-0731-Vision-NVFP4/discussions/3) 与 experiments/external_model_audits/webbrain_discussion3_status_20260808.json。本项目允许质疑公开验证边界，但不把“未核验”写成“未训练”或“造假”。
